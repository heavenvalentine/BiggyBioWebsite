...
var all_questions = [{
  question_string: "Food additives can prevent food from",
  choices: {
    correct: "spoiling/ developing mold",
    wrong: ["tasting bad", "looking good", "being good quality"]
  }
}, {
  question_string: "Fat substitues...",
  choices: {
    correct: "have less calories than regular fat",
    wrong: ["are used to make food taste better", "are worse than actual fat", "are used in the production of high-calories foods"]
  }
}, {
  question_string: "Any substance, other than food, that alters the function of both the mind and the body.",
  choices: {
    correct: "Drug",
    wrong: ["Liquid", "Alcohol", "Hormone"]
  }
}, {
  question_string: "The condition in which a person develops a mental or emotional need for a drug or other substance.",
  choices: {
    correct: "Psychological dependence",
    wrong: ["Tolerance", "Withdrawal", "Physical Dependence"]
  }
},
{
  question_string: "An amount of a drug so excessive that it makes someone ill or causes death.",
  choices: {
    correct: "Overdose",
    wrong: ["Addicition", "Tolerance", "Withdrawal"]
  }
}];
