...
var all_questions = [{
  question_string: "Root hairs develop from –",
  choices: {
    correct: "Region of maturation",
    wrong: ["Zone of elongation", "Meristematic region", "Region of mature cells"]
  }
}, {
  question_string: "In some leguminous plants the leaf base becomes swollen  which is called ",
  choices: {
    correct: "Pulvinus",
    wrong: ["leaf sheath", "bulbil", "thalamus"]
  }
}, {
  question_string: "A typical leaf consists of three main parts",
  choices: {
    correct: "leaf base, petiole and lamina",
    wrong: ["petiole, leaf margin and lamina", "leaf base, leaf apex and lamina", "leaf apex, petiole and lamina"]
  }
}, {
  question_string: "If more than two leaves arise at nodes, the phyllotaxy is which type?",
  choices: {
    correct: "Whorled",
    wrong: ["Alternate", "Opposite superposed", "Opposite Decussate"]
  }
},
{
  question_string: "Which of the following is not a type of Phyllotaxy?",
  choices: {
    correct: "Imbricate",
    wrong: ["Opposite", "Alternate", "Whorled"]
  }
}];
