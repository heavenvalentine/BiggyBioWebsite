...
var all_questions = [{
  question_string: "A cell is_____",
  choices: {
    correct: "the basic unit of structure and function in living organism",
    wrong: ["an organism", "a basic part of everything that we see", "found only in animals, not plants"]
  }
}, {
  question_string: "Which of the following are NOT found in animal cells",
  choices: {
    correct: "chloroplasts and cytoplasm",
    wrong: ["chloroplasts and cell wall", "cell wall and cell membrane", "mitochondria and nucleus"]
  }
}, {
  question_string: "The nucleus is like the ____________ of the cell.",
  choices: {
    correct: "brain",
    wrong: ["foot", "hand", "stomach"]
  }
}, {
  question_string: "Which of the following converts food into energy for the cell?",
  choices: {
    correct: "mitochondria",
    wrong: ["vacuole", "cytoplasm", "cell membrane"]
  }
},
{
  question_string: "What do vacuoles do? ",
  choices: {
    correct: "storage area for cells; water storage in plants ",
    wrong: ["They actually do not have an important role", "They protect the cell", "They are the brain of the cell"]
  }
}];
