...
var all_questions = [{
  question_string: "Voluntary muscles are found in",
  choices: {
    correct: "limbs",
    wrong: ["alimentary canal", "iris of the eye", "bronchi of lungs"]
  }
}, {
  ...
  question_string: "make ATP heterotrophically & photosynthetically",
  choices: {
    correct: "halophiles",
    wrong: ["thermoacidophiles", "extremophiles", "methanogens"]
  }
}, {
  question_string: "make ATP by converting CO2 & H2 into methane",
  choices: {
    correct: "methanogens",
    wrong: ["thermoacidophiles", "halophiles", "extremophiles"]
  }
}];
