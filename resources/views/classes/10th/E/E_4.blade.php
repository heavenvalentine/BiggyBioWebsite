...
var all_questions = [{
  question_string: "What is the original source of almost all energy in most ecosystems?",
  choices: {
    correct: "sunlight",
    wrong: ["carbohydrates", "water", "carbon"]
  }
}, {
  question_string: "An organism that produces its own food supply from inorganic compounds is called a(an)",
  choices: {
    correct: "autotroph",
    wrong: ["heterotroph", "consumer", "detritivore"]
  }
}, {
  question_string: "What is the term for each step in the transfer of energy and matter within a biological community?",
  choices: {
    correct: "trophic level",
    wrong: ["food web", "food pyramid", "trophic level"]
  }
}, {
  question_string: "The energy at each trophic level in the pyramid of energy decreases by a factor of ____.",
  choices: {
    correct: "10",
    wrong: ["1", "100", "2"]
  }
