...
var all_questions = [{
  question_string: "What do viruses need to reproduce?",
  choices: {
    correct: "They need a host cell",
    wrong: ["they need genetic material", "They need  bacteria", "They need insulin"]
  }
}, {
  question_string: "How does a virus cause a person to develop the common cold?",
  choices: {
    correct: "invades the host cell to reproduce",
    wrong: ["removes energy from the host cell", "produces toxins in the host cell", "protects the host cell from bacteria"]
  }
}, {
  question_string: "A virus can be classified by its type of",
  choices: {
    correct: "nucleic acid",
    wrong: ["mitochondria", "chromosomes", "carbohydrates"]
  }
}, {
  question_string: "When a virus invades a living cell, its _______takes over the cell's functions.",
  choices: {
    correct: "genetic material",
    wrong: ["outer coat", "core", "cytoplasm"]
  }
},
{
  question_string: "What part of a virus is the protein capsule that houses the genetic material (DNA/RNA)?",
  choices: {
    correct: "capsid",
    wrong: ["nucleus", "tail", "glycoprotein"]
  }
}];
