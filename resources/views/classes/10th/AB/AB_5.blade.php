...
var all_questions = [{
  question_string: "What kind of Archaea would you find in places such as volcanoes and hot vents on the ocean floor?",
  choices: {
    correct: "Thermophiles",
    wrong: ["Volcanophiles", "Halophiles", "Cyanobacteria"]
  }
}, {
  question_string: "All answers listed below are true about bacteria except",
  choices: {
    correct: "all are harmful",
    wrong: ["all are prokaryotes", "all are unicellular", "they do not have nucleus"]
  }
}, {
  question_string: "a rod shaped bacteria is called",
  choices: {
    correct: "bacillus",
    wrong: ["spiral", "coccus", "vibrio"]
  }
}, {
  question_string: "Use hydrogen sulfide (H2S) to make ATP - thus their environment STINKS",
  choices: {
    correct: "thermoacidophiles",
    wrong: ["halophiles", "extremophiles", "methanogens"]
  }
},
{
  question_string: "live in hot springs, thermal vents, places where temp exceeds 110 C",
  choices: {
    correct: "thermoacidophiles",
    wrong: ["halophiles", "extremophiles", "methanogens"]
  }
